<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.key" placeholder="标题" style="width: 200px;" class="filter-item" />
      <el-select
    ...
    >
      ...
      <el-table-column label="状态" class-name="status-col" width="auto">
        <template v-slot="{row}">
          <el-tag :type="row.status | statusFilter">{{ row.status | statusShowFilter }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        label="操作"
